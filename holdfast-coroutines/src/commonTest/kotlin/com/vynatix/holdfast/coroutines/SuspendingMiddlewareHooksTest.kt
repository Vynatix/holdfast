...
private class DualHookMiddleware(
    ...
    override fun onTransactionError(
        context: MiddlewareContext<HooksVault>,
        error: Throwable,
    ) {
    ...
    override suspend fun onTransactionErrorAsync(
        context: Middleware.MiddlewareContext<HooksVault>,
        error: Throwable,
    ) {
        delay(1)
...
class SuspendingMiddlewareHooksTest {
    ...
    @Test
    fun asyncHooksFireOnSuspendActionForAsyncOnlyMiddleware() =
        runBlocking {
            val v = HooksVault()
            val log = mutableListOf<String>()
            v.middlewares(AsyncOnlyMiddleware("M", log))
    ...
    @Test
    fun asyncErrorHookFiresOnThrowingSuspendAction() =
        runBlocking {
            val v = HooksVault()
            val log = mutableListOf<String>()
            v.middlewares(AsyncOnlyMiddleware("M", log))
    ...
    @Test
    fun syncAndAsyncHooksInterleavePerMiddleware() =
        runBlocking {
            val v = HooksVault()
            val log = mutableListOf<String>()
    ...
    @Test
    fun concentricRingOrderingAcrossTwoDualHookMiddlewaresOnSuccess() =
        runBlocking {
            val v = HooksVault()
            val log = mutableListOf<String>()
    ...
    @Test
    fun concentricRingOrderingAcrossTwoDualHookMiddlewaresOnError() =
        runBlocking {
            val v = HooksVault()
            val log = mutableListOf<String>()
            v.middlewares(
    ...
    @Test
    fun runCatchingIsolatesAsyncStartedHookFailureFromOtherMiddleware() =
        runBlocking {
            val v = HooksVault()
            val log = mutableListOf<String>()
            v.middlewares(
    ...
    @Test
    fun runCatchingIsolatesAsyncCompletedHookFailureFromOtherMiddleware() =
        runBlocking {
            val v = HooksVault()
            val log = mutableListOf<String>()
            v.middlewares(
    ...
    @Test
    fun runCatchingIsolatesAsyncErrorHookFailureFromOtherMiddleware() =
        runBlocking {
            val v = HooksVault()
            val log = mutableListOf<String>()
            v.middlewares(
    ...
    @Test
    fun bodyMaySuspendBetweenAsyncHooks() =
        runBlocking {
            val v = HooksVault()
            val log = mutableListOf<String>()
            v.middlewares(DualHookMiddleware("M", log))
