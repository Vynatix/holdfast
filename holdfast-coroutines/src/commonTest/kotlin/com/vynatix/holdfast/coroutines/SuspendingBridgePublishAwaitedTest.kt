...
class SuspendingBridgePublishAwaitedTest {
     ...
     */
    @Test
    fun publishAwaitedRunsInNonCancellable() =
        runBlocking {
     ...
     */
    @Test
    fun observersFireBeforePublishAwaitedCompletes() =
        runBlocking {
...
class SuspendingBridgeDedupTest {
    ...
    @Test
    fun distinctTrueStateWithSuspendingBridgeUnderSuspendActionDoesNotRepublishOnDedup() =
        runBlocking {
 ...
 */
private class SlowSuspendingKvStore(
