...
class InMemorySuspendingKvStoreTest {
    @Test
    fun put_then_get_round_trips_value() =
        runTest {
    ...
    @Test
    fun remove_on_missing_key_is_no_op() =
        runTest {
            val store: SuspendingKvStore = InMemorySuspendingKvStore()
    ...
    @Test
    fun initial_seed_is_visible_via_get_and_snapshot() =
        runTest {
    ...
    @Test
    fun concurrent_puts_serialize_no_lost_writes() =
        runTest {
            val store: SuspendingKvStore = InMemorySuspendingKvStore()
