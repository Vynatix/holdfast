// Twin of the root README's "Cross-store transactions" example. Executes the
// block and asserts the printed output and final balances the doc claims.
...
class RootReadmeCrossStoreTwin {
    @Test
    fun crossStoreTransferExecutesWithClaimedOutput() {
        ...
        assertEquals(listOf("transferred"), printed)
    }
}
