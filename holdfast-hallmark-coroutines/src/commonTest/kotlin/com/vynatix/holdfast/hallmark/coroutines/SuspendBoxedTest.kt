...
private class UniqueUsernameRule(
...
private class UniqueUsernameValidator(
    taken: Set<String>,
) : SuspendBoxedValidator<String, Username>() {
    override val specs =
        listOf(
...
class SuspendBoxedTest {
    @Test
    fun suspendValidateAndMutateAcceptsValidPrimitive() =
        runTest {
            val v = UserVault()
    ...
    @Test
    fun suspendValidateAndMutateRejectsAndRollsBack() =
        runTest {
            val v = UserVault()
