 ...
 * companion modules like `:vault-coroutines` and `:vault-compose` can reach
...
@RequiresOptIn(
    ...
    message = "This symbol is internal to the Vault library. Companion modules must @OptIn; " +
        "application code should not.",
)
@Retention(AnnotationRetention.BINARY)
@Target(AnnotationTarget.CLASS, AnnotationTarget.FUNCTION, AnnotationTarget.PROPERTY, AnnotationTarget.CONSTRUCTOR)
annotation class VaultInternalApi
